...
clus=np.array(df_cluster['Cluster 4'])
dist_clus=np.array(df_cluster['Distance 4'])
...
#*****************************************************************************\
#*****************************************************************************\
path_data_save=base_dir+'/Dropbox/Monash_Uni/SO/MAC/figures/clusters/Cyclones/4K/'
...
wdir_CL4_G4=np.arctan2(u_CL4_G4, v_CL4_G4)*(180/np.pi)+180
...
S.plot_skewt(color='r')
plt.savefig(path_data_save + '4K_C4_per.png', format='png', dpi=1200)
