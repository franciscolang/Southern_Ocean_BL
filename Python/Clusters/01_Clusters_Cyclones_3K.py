...
clus=np.array(df_cluster['Cluster 3'])
dist_clus=np.array(df_cluster['Distance 3'])
...
row = 2
column = 2
fig, axes = plt.subplots(row, column, facecolor='w', figsize=(13,13))
...
fig.tight_layout()
plt.savefig(path_data_save + '3K.png', format='png', dpi=1200)
...
#*****************************************************************************\
#*****************************************************************************\
path_data_save=base_dir+'/Dropbox/Monash_Uni/SO/MAC/figures/clusters/Cyclones/3K/'
...
wdir_CL4_G1=np.arctan2(u_CL4_G1, v_CL4_G1)*(180/np.pi)+180
...
wdir_CL4_G3=np.arctan2(u_CL4_G3, v_CL4_G3)*(180/np.pi)+180
...
plt.savefig(path_data_save + '4K_C1_per.png', format='png', dpi=1200)
...
S.plot_skewt(color='r')
plt.savefig(path_data_save + '4K_C2_per.png', format='png', dpi=1200)
...
S.plot_skewt(color='r')
plt.savefig(path_data_save + '4K_C3_per.png', format='png', dpi=1200)
