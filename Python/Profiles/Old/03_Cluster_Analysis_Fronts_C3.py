...
#*****************************************************************************\
#*****************************************************************************\
#df_clumac.ix[df_clumac.index.searchsorted(datetime(2009, 12,26,0))]
df_4KC3 = dfmy_fronts[dfmy_fronts['CL_4']=='3']
df_4KC3=df_4KC3[(np.isfinite(df_4KC3['Dist CFront'])) | (np.isfinite(df_4KC3['Dist WFront']))]

a=df_4KC3['CL_3'].groupby(df_4KC3['CL_3']).count()/len(df_4KC3)

ax = a.plot(kind='bar',colormap='jet',alpha=0.75, rot=0)
ax.set_ylabel('Frequency')
ax.set_xlabel('Cluster')
ax.set_title('Cluster 3 (4K) on 3K')
show()
