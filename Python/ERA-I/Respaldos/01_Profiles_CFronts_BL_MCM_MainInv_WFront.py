...
path_data_save=base_dir+'/Dropbox/Monash_Uni/SO/MAC/figures/ERAI/Main_Inv/Warm/'
...
#Reading CSV
#*****************************************************************************\
df_front= pd.read_csv(path_data_csv + 'df_wfront_19952010.csv', sep='\t', parse_dates=['Date'])
...
#*****************************************************************************\
    ...
    df['catdist_fron'] = pd.cut(df['Dist WFront'], bins, labels=bins[0:-1])
...
#*****************************************************************************\
    ...
    dfc['catdist_fron'] = pd.cut(dfc['Dist WFront'], bins, labels=bins[0:-1])
...
#*****************************************************************************\
    ...
    ax.errorbar(np.arange(0.5,20,1), NewValue_era, yerr=NewValue_era_std, fmt='-ow',label='Main Inv.',markeredgecolor='none')
    #ax.legend(loc=1, numpoints=1)
...
#*****************************************************************************\
    ...
    #ax0.set_xlabel('Distance to front: warm to cold sector (deg)', size=12)
...
#*****************************************************************************\
    ...
    ax1.set_xlabel('Distance to front: warm to cold sector (deg)', size=12)
    ax1.grid()
    ax1.margins(0.03)
    plt.tight_layout()
