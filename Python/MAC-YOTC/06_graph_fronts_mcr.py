...
df_mac= pd.read_csv(path_data + 'df_mac_19952010.csv', sep='\t', parse_dates=['Date'])
df_yotc= pd.read_csv(path_data + 'df_yotc_19952010.csv', sep='\t', parse_dates=['Date'])
df_my= pd.read_csv(path_data + 'df_macyotc_19952010.csv', sep='\t', parse_dates=['Date'])
...
df_macfro['Dist Front']=df_macfro['Dist Front']*-1
df_yotcfro['Dist Front']=df_yotcfro['Dist Front']*-1
df_myfro['Dist Front']=df_myfro['Dist Front']*-1
...
ax1.bar(bin_edges[df1:df2],bin_means[df1:df2],width,alpha=0.5, color=color2,label='prefront',yerr=[np.zeros(10), bin_std[df1:df2]], error_kw=error_config)
