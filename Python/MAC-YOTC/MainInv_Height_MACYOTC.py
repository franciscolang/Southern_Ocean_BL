...
#df_era= pd.read_csv(path_data_csv + 'MCR/df_era_19952010_5k_2.csv', sep='\t', parse_dates=['Date'])

df_era= pd.read_csv(path_data_csv + 'MCR/df_macera_19952010_5k.csv', sep='\t', parse_dates=['Date'])

df_mei= pd.read_csv(path_data_csv + 'MCR/df_macera_19952010_5k_2.csv', sep='\t', parse_dates=['Date'])
...
ax0.errorbar(bin_edges, bin_means_mac, yerr=bin_std_mac, fmt='-ob',label='MAC-YOTC')
#ax0.errorbar(bin_edges, bin_means_yotc, yerr=bin_std_yotc, fmt='-or',label='YOTC')
ax0.errorbar(bin_edges, bin_means_mei, yerr=bin_std_mei, fmt='-og',label='MAC-ERAi')
ax0.errorbar(bin_edges, bin_means_era, yerr=bin_std_era, fmt='-oy',label='ERAi')
